...
export function ErrorState({ onRetry }: { onRetry: () => void }) {
  return (
    <div className="flex min-h-80 items-center justify-center rounded-lg border border-[var(--theme-danger-border)] bg-[var(--theme-danger-soft)] p-6 text-center lg:min-h-[calc(100svh-16rem)]">
      <div className="mx-auto max-w-xl">
        <AlertCircle
          className="mx-auto h-8 w-8 text-[var(--theme-danger)]"
          aria-hidden="true"
        />
