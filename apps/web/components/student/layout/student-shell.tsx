...
import { StudentLearningTransitionProvider } from "@/components/student/learning-transition/student-learning-transition-provider";
...
export function StudentShell({
  ...
  return (
    <StudentLearningTransitionProvider>
      <div
