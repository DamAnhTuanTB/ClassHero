...
export function FlashcardResultScreen({
  ...
  return (
    <div className="fixed inset-0 z-[80] overflow-y-auto bg-[linear-gradient(180deg,#ede9fe_0%,#faf5ff_100%)] text-slate-950 dark:bg-[var(--theme-bg)] dark:text-[var(--theme-text-strong)]">
