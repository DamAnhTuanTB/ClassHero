...
export function QuizRunnerLoadingScreen() {
  ...
  return (
    <div
      className="fixed inset-0 z-[80] overflow-hidden bg-[linear-gradient(180deg,#e0f2fe_0%,#f0f9ff_100%)] text-slate-950 dark:bg-[var(--theme-bg)] dark:text-[var(--theme-text-strong)]"
      aria-busy="true"
