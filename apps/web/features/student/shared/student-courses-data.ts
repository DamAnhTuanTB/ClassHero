...
export const studentCourses: StudentCourse[] = [
  ...
  },
  {
    ...
    nextLesson: {
      ...
      kind: "next",
      title: "Buổi học 6: Đa thức một biến",
    },
  ...
  },
  {
    ...
    nextLesson: {
      ...
      kind: "last",
      title: "Buổi học 36: Tổng ôn cuối khóa",
    },
...
export const studentCourseDetails: Partial<Record<string, StudentCourseDetail>> = {
  "toan-7-nen-tang": {
    chapters: [
      {
        ...
        lessons: [
          ...
          },
          {
            ...
            status: "completed",
            title: "Buổi 2. Cộng, trừ số hữu tỉ",
          },
          {
            durationMinutes: 45,
            id: "lesson-math-7-multiply-divide",
            status: "completed",
            title: "Buổi 3. Nhân, chia số hữu tỉ",
          },
          {
            durationMinutes: 35,
            id: "lesson-math-7-powers",
            status: "completed",
            title: "Buổi 4. Lũy thừa của một số hữu tỉ",
          },
          {
            durationMinutes: 40,
            id: "lesson-math-7-ratio",
          ...
          },
          {
            ...
            status: "locked",
            title: "Buổi 6. Luyện tập tỉ lệ thức",
          },
        ],
        order: 1,
        progressPercent: 100,
        ...
        lessons: [
          {
            ...
            status: "locked",
            title: "Buổi 1. Đại lượng tỉ lệ thuận",
          },
          {
            durationMinutes: 40,
            id: "lesson-math-7-inverse-proportion",
            status: "locked",
            title: "Buổi 2. Đại lượng tỉ lệ nghịch",
          },
        ],
        order: 2,
        progressPercent: 0,
        ...
        lessons: [
          {
            ...
            status: "locked",
            title: "Buổi 1. Bảng dữ liệu ban đầu",
          },
        ],
        order: 3,
        progressPercent: 0,
    ...
    continueLessonTitle: "Buổi học 5: Tỉ lệ thức",
    totalHours: 18,
  },
  "toan-7-nang-cao": {
    chapters: [
      {
        ...
        lessons: [
          ...
          },
          {
            ...
            status: "locked",
            title: "Buổi 2. Mặt phẳng tọa độ",
          },
          {
            durationMinutes: 45,
            id: "lesson-math-7-linear-relation",
            status: "locked",
            title: "Buổi 3. Đồ thị hàm số",
          },
        ],
        order: 1,
        progressPercent: 0,
        ...
        lessons: [
          {
            ...
            status: "locked",
            title: "Buổi 1. Biểu thức đại số nâng cao",
          },
        ],
        order: 2,
        progressPercent: 0,
    ...
    continueLessonTitle: "Buổi học 1: Hàm số",
    totalHours: 12,
  },
  "toan-7-luyen-tap": {
    chapters: [
    ...
    continueLessonTitle: "Buổi học 6: Đa thức một biến",
    totalHours: 10,
  },
  "toan-7-tong-on": {
    chapters: [
        ...
        lessons: [
          {
            ...
            status: "completed",
            title: "Buổi 34. Tổng hợp đại số",
          },
          {
            durationMinutes: 45,
            id: "lesson-math-7-final-topic-2",
            status: "completed",
            title: "Buổi 35. Tổng hợp hình học",
          },
          {
            durationMinutes: 50,
            id: "lesson-math-7-final-review",
    ...
    continueLessonTitle: "Buổi học 36: Tổng ôn cuối khóa",
    totalHours: 14,
  },
  "toan-7-tang-toc": {
    chapters: [
        ...
        lessons: [
          {
            ...
            isTrial: true,
            status: "current",
            title: "Buổi 1. Học thử: Ôn số hữu tỉ",
          },
          {
            durationMinutes: 35,
            ...
            isTrial: true,
            status: "next",
            title: "Buổi 2. Học thử: Tỉ lệ thức nhanh",
          },
          {
            durationMinutes: 40,
        ...
        lessons: [
          {
            ...
            status: "locked",
            title: "Buổi 1. Biểu thức đại số chọn lọc",
          },
          {
            durationMinutes: 50,
            id: "lesson-math-7-speed-test",
            status: "locked",
            title: "Buổi 2. Bài kiểm tra tăng tốc",
          },
        ],
        order: 2,
        progressPercent: 0,
    ...
    continueLessonKind: "first",
    continueLessonTitle: "Buổi học 1: Học thử - Ôn số hữu tỉ",
    totalHours: 9,
  },
};
...
export const purchasedStats: StudentCourseStat[] = [
  ...
  { label: "buổi học hôm nay", value: "1" },
];
