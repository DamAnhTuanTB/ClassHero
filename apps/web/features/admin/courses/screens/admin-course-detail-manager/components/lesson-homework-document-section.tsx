...
import { ClipboardList, Eye, FilePlus2, Trash2, Upload } from "lucide-react";
...
export function LessonHomeworkDocumentSection({
  ...
  return (
    <section
      data-testid="lesson-homework-documents-section"
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex min-w-0 flex-1 items-center gap-3">
          ...
          <div className="flex min-w-0 items-center gap-2">
            ...
            />
            <span
              data-testid="homework-document-count"
              aria-label={`${homeworkCount} bài tập về nhà`}
