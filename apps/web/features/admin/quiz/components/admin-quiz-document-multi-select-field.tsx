...
export function AdminQuizDocumentMultiSelectField({
  documents,
  error,
  onChange,
  value,
            ...
            documents.map((document) => {
              ...
              return (
                <button
                  ...
                  aria-disabled={!document.canUseForQuiz}
                  disabled={!document.canUseForQuiz}
                  onClick={() =>
                    onChange(
                      isSelected
                ...
                >
                  ...
                  <span className="min-w-0 flex-1">
                    ...
                    {document.quizUnavailableReason ? (
                      <span className="mt-0.5 block text-xs font-semibold text-[var(--theme-text-muted)]">
                        {document.quizUnavailableReason}
                      </span>
                    ) : null}
