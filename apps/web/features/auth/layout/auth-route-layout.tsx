...
import { AuthDevHydrationBoundary } from "@/features/auth/components";
...
export function AuthRouteLayout({ children }: { children: ReactNode }) {
  ...
  return (
    ...
    >
      ...
      <section
        className="theme-auth-shell relative mx-auto min-h-[calc(100vh-2rem)] max-w-[560px] overflow-hidden rounded-2xl sm:min-h-[calc(100vh-4rem)] lg:grid lg:max-w-[1280px] lg:grid-cols-[1fr_0.94fr] lg:rounded-[2.35rem]"
      >
