...
import { LearningStreakStat } from "@/features/student-courses/components/learning-streak-stat";
import { studentProfile } from "@/features/student-courses/data";

export function StudentLearningGreetingPanel() {
  return (
    <section
