...
const PHYSICS_SUMMARY_SYSTEM_PROMPT = [
...
export function buildPhysicsLessonSummarySystemPrompt(
  subject: LessonSummarySubjectSnapshot,
) {
  return PHYSICS_SUMMARY_SYSTEM_PROMPT.replaceAll("__SUBJECT_NAME__", subject.name);
}
