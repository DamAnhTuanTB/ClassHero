...
const CHEMISTRY_SUMMARY_SYSTEM_PROMPT = [
...
export function buildChemistryLessonSummarySystemPrompt(
  subject: LessonSummarySubjectSnapshot,
) {
  return CHEMISTRY_SUMMARY_SYSTEM_PROMPT.replaceAll("__SUBJECT_NAME__", subject.name);
}
