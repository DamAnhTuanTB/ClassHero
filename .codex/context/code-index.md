...
| `apps/web/features/admin/lessons`      | Admin lesson detail/video tooling; M3.8 transcript panel/row/confirm dialog nằm trong `components/`, validation timestamp/transcript nằm trong `schemas/lesson-video-transcript-schema.ts` |
