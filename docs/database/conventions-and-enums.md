...
LearningPathKind: CATALOG, PERSONALIZED
Difficulty: EASY, MEDIUM, HARD, MIXED
QuestionType: MULTIPLE_CHOICE, TRUE_FALSE, MULTI_STATEMENT_TRUE_FALSE, TEXT_INPUT
...
BackgroundJobQueue: DOCUMENT_PROCESSING, EMBEDDING, AI_GENERATION, NOTIFICATION_DELIVERY, EMAIL_DELIVERY, ZALO_DELIVERY, DIAGRAM_RENDERING, PAYMENT_POSTPROCESS, PERSONAL_LEARNING_PATH_CLONE
