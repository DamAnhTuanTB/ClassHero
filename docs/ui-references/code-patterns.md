...
| Loading, empty, error, disabled/pending state    | `docs/ui-references/code-patterns/states.md#1-loading-empty-error-state`                                                 | Query/mutation hook hiện có nếu state đến từ API        |
