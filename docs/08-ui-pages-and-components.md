...
| Admin lesson document upload/status       | `M4.5`                 | `M4.2`                            | `M1.2`, `M1.3`         | `M4.1`, `M4.3`, `M4.4`                        | Flow chính: upload một source PDF dài ở cấp lộ trình, extract/OCR theo trang, admin gán page range cho từng lesson rồi chunk theo lesson. Mỗi lesson có nút upload/thay thế tài liệu gốc và có thể upload tài liệu bổ sung trực tiếp. |
