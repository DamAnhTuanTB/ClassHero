...
| Note                                                        | Chủ đề                                                                                | Task liên quan                         | Trạng thái  |
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------- | -------------------------------------- | ----------- |
| [Prisma database foundation](foundation/prisma-database.md) | Prisma, migration, pgvector, PrismaService, payment/AI/notification foundation models | `M1.1`, `M1.2`, `M1.3`, `M1.4`, `M1.5` | Đã cập nhật |
