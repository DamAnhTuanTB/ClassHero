...
| Note                                                        | Chủ đề                                                                 | Task liên quan         | Trạng thái  |
| ----------------------------------------------------------- | ---------------------------------------------------------------------- | ---------------------- | ----------- |
| [Prisma database foundation](foundation/prisma-database.md) | Prisma, migration, pgvector, PrismaService, foundation/learning models | `M1.1`, `M1.2`, `M1.3` | Đã cập nhật |
