...
| Lesson document upload/PDF     | `M1.2` Done, `M1.3` Done                           | `M4.1` storage/upload foundation partial, `M4.2` pending      | `M4.5`                               | local MinIO dev added, `M4.3`, `M4.4` pending | worker tests `M14.1`                                                  | In progress |
