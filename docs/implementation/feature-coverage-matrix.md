...
| Public/student course browsing | `M1.3` Done                                        | `M3.1` minimal published list/detail, full `M3.3` Done        | `M3.5`                               | payment CTA `M8.4`               | `M3.1`, `M3.3` focused API/typecheck, `M14.3`                         | In progress |
