...
| Admin course/lesson management | `M1.3` Done                      | `M3.1`, `M3.2`         | `M3.4`                | -                                | `M14.1`, `M14.2`     | In progress |
...
| Student progress/dashboard     | `M1.3` Done, `M1.4`, `M1.5`      | `M7.5`                 | `M7.7`                | notification/XP `M10.x`, `M13.x` | `M14.3`              | In progress |
| Student notes/private comments | `M1.4`                           | `M7.6`                 | `M7.6`                | file image optional `M4.1`       | `M14.1`              | Planned     |
| Discount/payment/enrollment    | `M1.3` Done, `M1.5`              | `M8.1`, `M8.2`, `M8.3` | `M8.4`, `M8.5`        | payOS webhook                    | `M14.2`              | In progress |
...
| Parent portal                  | `M1.2` Done, `M1.3` Done, `M1.4` | `M11.1`-`M11.4`        | `M11.1`-`M11.4`       | payment/news integration         | `M14.3`              | In progress |
