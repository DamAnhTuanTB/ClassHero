...
| Student progress/dashboard     | `M1.3` Done, `M1.4` Done, `M1.5`      | `M7.5`                 | `M7.7`                | notification/XP `M10.x`, `M13.x` | `M14.3`              | In progress |
...
| AI generation/explanation/chat | `M1.4` Done, `M1.5`                   | `M9.2`-`M9.7`          | `M9.6`, `M9.8`        | OpenAI/Gemini provider, RAG      | schema validation    | In progress |
| Notification                   | `M1.5`                                | `M10.1`, `M10.4`       | `M10.2`               | Socket.IO, email/Zalo workers    | `M14.2`              | Planned     |
| Parent portal                  | `M1.2` Done, `M1.3` Done, `M1.4` Done | `M11.1`-`M11.4`        | `M11.1`-`M11.4`       | payment/news integration         | `M14.3`              | In progress |
